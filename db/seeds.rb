...
tags = ['INTJ', 'INTP', 'ENTJ', 'ENTP', 'INFJ', 'INFP', 'ENFJ', 'ENFP', 'ISTJ', 'ISFJ', 'ESTJ', 'ESFJ', 'ISTP', 'ISFP', 'ESTP', 'ESFP', 'あるある', '恋愛', '繋がりたい', '心理機能', 'ソシオニクス', '有名人', '偏見', 'その他']
.each do |name|
...
post1 = Post.find_or_create_by!(title: "建築家") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'INTJ').id
  post.status = 1
end
...
post2 = Post.find_or_create_by!(title: "論理学者") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'INTP').id
  post.status = 2
end
...
post3 = Post.find_or_create_by!(title: "指揮官") do |post|
  ...
  post.tag_ids = [Tag.find_by(name: 'ENTJ').id, Tag.find_by(name: 'あるある').id]
  post.status = 2
end
...
post5 = Post.find_or_create_by!(title: "提唱者") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'INFJ').id
  post.status = 0
end
...
post6 = Post.find_or_create_by!(title: "仲介者") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'INFP').id
  post.status = 1
end
...
post7 = Post.find_or_create_by!(title: "主人公") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ENFJ').id
  post.status = 0
end
...
post8 = Post.find_or_create_by!(title: "運動家") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ENFP').id
  post.status = 0
end
...
post9 = Post.find_or_create_by!(title: "管理者") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ISTJ').id
  post.status = 1
end
...
post10 = Post.find_or_create_by!(title: "擁護者") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ISFJ').id
  post.status = 0
end
...
post11 = Post.find_or_create_by!(title: "幹部") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ESTJ').id
  post.status = 0
end
...
post12 = Post.find_or_create_by!(title: "領事") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ESFJ').id
  post.status = 0
end
...
post13 = Post.find_or_create_by!(title: "巨匠") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ISTP').id
  post.status = 0
end
...
post14 = Post.find_or_create_by!(title: "冒険家") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ISFP').id
  post.status = 1
end
...
post15 = Post.find_or_create_by!(title: "起業家") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ESTP').id
  post.status = 0
end
...
post16 = Post.find_or_create_by!(title: "エンターテイナー") do |post|
  ...
  post.tag_ids = Tag.find_by(name: 'ESFP').id
  post.status = 0
end
...
post17 = Post.find_or_create_by!(title: "不明") do |post|
  ...
  post.tag_ids = Tag.find_by(name: '繋がりたい').id
  post.status = 0
end
